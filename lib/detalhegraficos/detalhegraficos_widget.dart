...
class DetalhegraficosWidget extends StatefulWidget {
  const DetalhegraficosWidget({
    Key? key,
    this.budgetDetails,
  }) : super(key: key);
  ...
  @override
  _DetalhegraficosWidgetState createState() => _DetalhegraficosWidgetState();
}

class _DetalhegraficosWidgetState extends State<DetalhegraficosWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<BudgetsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final detalhegraficosBudgetsRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
                    ...
                    await Navigator.push(
                      ...
                      PageTransition(
                        ...
                        child: BudgetDELETEWidget(
                          budgetList: detalhegraficosBudgetsRecord.reference,
                        ),
                      ),
                    );
                  },
                              ...
                              Expanded(
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0, 4, 0, 0),
                                  child: Text(
                                    detalhegraficosBudgetsRecord.budetName!,
                            ...
                            children: [
                              Text(
                                valueOrDefault<String>(
                                  detalhegraficosBudgetsRecord.budgetTime,
                                  '4 Days Left',
                                ),
                    ...
                    stream: queryTransactionsRecord(
                      queryBuilder: (transactionsRecord) =>
                          transactionsRecord.where('budgetAssociated',
                              isEqualTo:
                                  detalhegraficosBudgetsRecord.reference),
                    ),
                    builder: (context, snapshot) {
                      // Customize what your widget looks like when it's loading.
                      if (!snapshot.hasData) {
                          ...
                          queryBuilder: (transactionsRecord) =>
                              transactionsRecord
                                  .where('budgetAssociated',
                                      isEqualTo: detalhegraficosBudgetsRecord
                                          .reference)
